        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
                     <c:url value="/saveGuest" var="saveGuest"/>
					<form:form class="login100-form validate-form" 
						...
						<div class="wrap-input100 validate-input">
							...
							<form:input class="input100" path="name"  />
							<span class="focus-input100"></span>
						</div>
						
						<div class="wrap-input100 validate-input" >
							<span class="label-input100">Guest idNumber</span>
							<form:input class="input100" path="idNumber"  />
							<span class="focus-input100"></span>
						</div>
						
						<div class="wrap-input100 validate-input" >
							<span class="label-input100">Guest phoneNumber</span>
							<form:input class="input100" path="phoneNumber"  />
							<span class="focus-input100"></span>
						</div>
						
						<div class="wrap-input100 validate-input" >
							<span class="label-input100">Guest room</span>
							<form:input class="input100" path="room"  />
							<span class="focus-input100"></span>
						</div>
						
						<div class="wrap-input100 validate-input" >
							<span class="label-input100">Guest checkinDate</span>
							<form:input class="input100" path="checkinDate"  />
							<span class="focus-input100"></span>
						</div>
						...
						<div class="wrap-input100 validate-input" >
							...
							<form:input class="input100" path="checkoutDate"  />
							<span class="focus-input100"></span>
						</div>
