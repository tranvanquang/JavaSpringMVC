    ...
    <div class="main-panel">
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-8">
                    <h2 class="roomId">View Service Room</h2>
                    <table class="table table-striped">
					  ...
					  <tbody>
					  	<c:if test="${not empty listAllService }">
					  		<c:forEach varStatus="loop" var="service" items="${listAllService }">
					  		
					  			<tr>
					      			<th scope="row">${loop.count}</th>
					     			  <td>${service.name }</td>
					    			  <td>${service.price }</td>
					      			<td><a href="<c:url value="/room-booked-list/delete-serviceRoom/${service.id }" />">Delete</a></td>
					   		 </tr>
					  		</c:forEach>
